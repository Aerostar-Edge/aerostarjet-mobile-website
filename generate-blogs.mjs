...
const outPath = path.join(__dirname, '../src/data/blogs.ts')
...
const posts = [
  {
    ...
    blocks: [
      ...
      { type: 'heading', text: 'What is a Tours & Travelling Course?' },
      {
        type: 'paragraph',
      ...
      { type: 'heading', text: 'Training Generally Includes' },
      {
        type: 'list',
        items: [
      ...
      { type: 'heading', text: 'Why Choose Tours & Travelling as a Career?' },
      {
        type: 'list',
        items: [
      ...
      { type: 'heading', text: 'Why Students Choose Aerostarjet?' },
      {
        type: 'paragraph',
        ...
        items: [
          {
            ...
            answer:
              'A course providing knowledge about tourism management, ticketing systems, travel operations, customer service, hospitality, and tour planning to prepare students for careers in the travel industry.',
          },
          {
            question: '2. Who can apply?',
            answer:
              'Students who have completed their educational qualifications according to course requirements. Eligibility may vary depending on the institute and training program.',
          },
          {
            question: '3. What skills are important?',
            answer:
              'Communication abilities, customer handling, teamwork, problem-solving, confidence, organisational abilities, and professional presentation.',
          },
          {
            question: '4. What career opportunities are available?',
            answer:
              'Travel Consultants, Tour Executives, Ticketing Executives, Travel Coordinators, Airport Customer Service Executives, Hospitality Professionals, and Tourism Managers.',
          },
          {
            question: '5. Does Aerostarjet provide placement assistance?',
            answer:
              'Yes — interview preparation support, personality development sessions, career guidance, and placement assistance opportunities.',
          },
        ],
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      { type: 'heading', text: 'What is an Air Hostess Training Program?' },
      {
        type: 'paragraph',
      ...
      { type: 'heading', text: 'Key Training Areas' },
      {
        type: 'list',
        items: [
      ...
      { type: 'heading', text: 'Why Choose Aerostarjet for Air Hostess Training?' },
      {
        type: 'paragraph',
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'heading', text: 'What Do Hotel Management Courses Cover?' },
      {
        type: 'list',
        items: [
      ...
      { type: 'heading', text: 'Career Opportunities in Hospitality' },
      {
        type: 'paragraph',
      ...
      { type: 'heading', text: 'Why Aerostar Jet?' },
      {
        type: 'paragraph',
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'heading', text: 'Why Choose Airhostess & Cabin Crew as a Career?' },
      {
        type: 'list',
        items: [
      ...
      { type: 'heading', text: 'Why Choose Aerostar Jet?' },
      {
        type: 'list',
        items: [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'heading', text: 'Understanding Tours & Travel Management Education' },
      {
        type: 'paragraph',
      ...
      { type: 'heading', text: 'Key Components of the Course' },
      {
        type: 'list',
        items: [
      ...
      { type: 'heading', text: 'Why Choose Aerostarjet?' },
      {
        type: 'paragraph',
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'heading', text: 'Why Choose Fashion Designing as a Career?' },
      {
        type: 'list',
        items: [
      ...
      { type: 'heading', text: 'Why Interior Designing is a Smart Career Choice' },
      {
        type: 'paragraph',
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'heading', text: 'What These Courses Cover' },
      {
        type: 'list',
        items: [
      ...
      { type: 'heading', text: 'Career Paths Available' },
      {
        type: 'paragraph',
      ...
      { type: 'heading', text: "Aerostarjet's Approach" },
      {
        type: 'paragraph',
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'heading', text: 'Ground Subjects (DGCA Examinations)' },
      {
        type: 'list',
        items: [
      ...
      { type: 'heading', text: 'Why Get a PPL?' },
      {
        type: 'paragraph',
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'heading', text: 'What Aerostar Offers' },
      {
        type: 'list',
        items: [
      ...
      { type: 'heading', text: 'The Aerostar Difference' },
      {
        type: 'paragraph',
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'heading', text: 'Why Personality Development Matters' },
      {
        type: 'list',
        items: [
      ...
      { type: 'heading', text: 'What Aerostar Focuses On' },
      {
        type: 'list',
        items: [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'heading', text: 'What to Look for in a Cabin Crew Training Institution' },
      {
        type: 'list',
        items: [
      ...
      { type: 'heading', text: "Aerostar's Cabin Crew Training" },
      {
        type: 'paragraph',
      ...
      { type: 'heading', text: 'Career Roles After Training' },
      {
        type: 'list',
        items: [
...
export const blogPosts = ${JSON.stringify(posts, null, 2)}.map((post) => ({
  ...post,
  excerpt: firstParagraph(post.blocks),
})) as BlogPost[]
...
fs.writeFileSync(outPath, header.replace('function firstParagraph(blocks)', 'function firstParagraph(blocks: BlogBlock[])'))
